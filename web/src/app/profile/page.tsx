    ...
    return (
        <div className="min-h-screen bg-background flex flex-col font-sans">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 max-w-3xl">
                ...
                <Card className="mt-6">
                    <CardHeader>
                        <CardTitle className="text-lg">Your AI Production Team</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-sm text-muted-foreground mb-4">
                            MovieShaker automatically assigns the right AI specialist to every task. No model selection required.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {[
                                { icon: "✍️", name: "CoWriter", description: "Script development, story, creative writing, festival strategy, funding pitches" },
                                { icon: "🎬", name: "CoProducer", description: "Production planning, budgeting, scheduling, crew and cast management" },
                                { icon: "🎥", name: "CoDirector", description: "Shot lists, visual direction, video generation" },
                                { icon: "🎨", name: "CoDesigner", description: "Moodboards, visual identity, character and object images" },
                            ].map((team) => (
                                <div key={team.name} className="flex items-start gap-3 p-3 rounded-md border bg-muted/30">
                                    <span className="text-xl leading-none mt-0.5">{team.icon}</span>
                                    <div>
