...
def _upsert_project_script_from_fiab(
    ...
    script_name = title.strip() or "CoWriter Draft"
    ...
    generated_script = next(
        (s for s in scripts if (s.description or "") == "Generated by CoWriter"),
        None,
    )
    ...
    if generated_script is None:
        ...
        generated_script = Script(
            ...
            user_id=user_id,
            name=script_name,
            description="Generated by CoWriter",
            file_path=rel_path,
            is_current=True,
